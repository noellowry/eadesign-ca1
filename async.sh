...
do 
  ...
  set -- $var
  echo "$1 $2"
  total_time=`echo "scale=6; $total_time + $2" | bc`;
done
#echo "scale=6;total_time: $total_time"
echo "ASYNC average time taken: `echo "scale=6; $total_time/$count" | bc`";
#echo $DATE

gcloud functions call create-graph --project eadesign-269520 --data '{"filename":"2.1-graph-'"$DATE"'.png", "plottype":"line", "x":["2000", "10000", "20000"], "y":["0.066996","00.067789","0.067247", "0.066995", "0.067226", "0.066946", "0.066934", "0.066439", "0.066958"], "ylab":["Door publish interval: 10ms", "Door publish interval: 50ms", "Door publish interval: 100ms"]}';
